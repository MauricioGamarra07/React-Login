...
function Login() {
    ...
    return (
        <>
            <form className="form_container" onSubmit={(e) => { capturarDatos(e) }}>
                ...
                <div className="input_container">
                    ...
                    <input placeholder="name@mail.com" title="Inpit title" name="input-email" type="text" className="input_field" id="email_field" />
                </div>
                <div className="input_container">
                    ...
                    <input placeholder="Password" title="Inpit title" name="input-password" type="password" className="input_field" id="password_field" autoComplete='cc-csc' />
                </div>
                ...
                <p>Aún no esta registrado? <a href="#">Regístrese aquí</a></p>
            </form>
        </>
    )
}
